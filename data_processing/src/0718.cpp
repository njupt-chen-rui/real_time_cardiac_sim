...
int main(){
    cout << "begin" << endl;
    string file_name = "LV1_0718";
    string file_format = ".inp";
    string input_path = "./data/input/LV1_0718/" + file_name + file_format;
    ...
    string vert_fiber_path = "./data/input/LV1_0718/fiber.txt";
    ...
    // read bou of LV1
    string LV1_bou_path = "./data/input/LV1_0718/faces.inp";
    ...
    out.output_bou_epi_lv_face(bou_endo_lv);
